...
const Navbar: React.FC<NavbarProps> = ({ currentPage, onNavigate }) => {
  ...
  return (
    <header className="fixed top-0 z-50 w-full backdrop-blur-md bg-background-dark/80 border-b border-white/10 px-4 md:px-10 lg:px-20 py-3 md:py-4">
      <div className="flex items-center justify-between max-w-[1440px] mx-auto">
        <div 
          className="flex items-center gap-2 md:gap-3 cursor-pointer group"
          onClick={() => onNavigate('home')}
        >
          <div className="size-10 md:size-15 transform group-hover:scale-110 transition-transform flex items-center justify-center">
            <img 
          ...
          <h2 className="text-white text-xl md:text-2xl lg:text-3xl font-serif font-bold tracking-tight">JP TIRES</h2>
        </div>
